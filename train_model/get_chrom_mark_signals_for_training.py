...
def get_chrom_mark_signals_for_training_from_chromHMMInput(binarized_signal_folder, train_sorted_coord_fn, output_fn):
	...
	sample_df['region'] = np.floor(sample_df['end'] / (NUM_BP_PER_BIN * NUM_BIN_PER_REGION)).astype(int)
...
def usage():
	...
	print ("binarized_signal_folder: where we store the signals of binarized marks that have been created as input for chromHMM LearnModel")
